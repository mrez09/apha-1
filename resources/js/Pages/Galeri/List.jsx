...
export default function List({ galeri, props }) {
    ...
    return (
        <FrontendLayout>
            <Head>
                <title>
                    Galeri Asosiasi Pengajar Hukum Adat (APHA) Indonesia
                </title>
                <meta
                    head-key="Description"
                    name="description"
                    content="Kumpulan Photo Dokumentasi Kegiatan Asosiasi Pengajar Hukum Adat (APHA) Indonesia"
                />
                <meta
                ...
                <meta
                    ...
                    content="Kumpulan Photo Dokumentasi Asosiasi Pengajar Hukum Adat (APHA) Indonesia"
                />
                <meta
