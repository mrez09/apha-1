                ...
                <div class="row g-5 d-flex justify-content-center">
                    <div class="col-md-11 ">
                        <article class="blog-post mt-5">
                            <h2 class="blog-post-title">{buku.name}</h2>
                            <p class="blog-post-meta">
                                {moment(buku.created_at).format(
                                    "dddd D MMMM YYYY"
                                )}
                            </p>
                            <img
                                ...
                                alt=""
                            />
                            <p className="kon-10">{parse(buku.decription)}</p>
                            <hr />
                            <div class="detail-article__share-wrapper">
                                ...
                                <div class="detail-article__share">
                                    ...
                                    >
                                        <span>
                                            <img
                                                ...
                                                class="detail-article__share-icon"
                                                alt="share Copy Link"
                                            />
                                        </span>
                                    </CopyToClipboard>
                                    ...
                                    <a
                                        ...
                                        class="detail-article__share-link"
                                        target="_blank"
                                    >
                                        <img
