...
export default function List(props) {
    ...
    const submit = (e) => {
        ...
        if (data.img == props.prosiding.img) {
            delete data.img;
        }

        router.post(
            route("admin.dashboard.prosiding.update", props.prosiding.id),
            {
                _method: "PUT",
                ...data,
            }
    ...
    return (
        <AuthenticatedLayout auth={props.auth} errors={props.errors}>
            ...
            <div className="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h1 className="h2">
                    Update Prosiding : <p>{props.prosiding.name}</p>
                </h1>
                ...
                <div className="btn-toolbar mb-2 mb-md-0">
                    <div className="btn-group me-2">
                        <a
                            type="button"
                            href={route("admin.dashboard.prosiding.index")}
                        ...
                        <div className="row g-3">
                            <div className="col-sm-12">
                                ...
                                <input
                                    type="text"
                                    name="name"
                                    defaultValue={props.prosiding.name}
                                    placeholder="Masukan Nama Prosiding"
                            ...
                            <div className="col-md-6">
                                ...
                                <input
                                    ...
                                    defaultValue={props.prosiding.url}
                            ...
                            <div className="col-sm-6">
                                ...
                                <img
                                    src={`/storage/${props.prosiding.thumbnail}`}
                                    alt=""
                                />
                                <input
                                    type="file"
                            ...
                            <div className="col-sm-12">
                                ...
                                <CKEditor
                                    ...
                                    name="decription"
                                    data={props.prosiding.decription}
                                    //data={props.prosiding.decription}
