...
export default function List(props) {
    ...
    const submit = (e) => {
        ...
        router.post(route("admin.dashboard.periode.update", props.periode.id), {
            _method: "PUT",
            ...data,
        });
    };
    return (
        <AuthenticatedLayout auth={props.auth} errors={props.errors}>
            ...
            <div className="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h1 className="h2">
                    Update Periode : <p>{props.periode.namaperiode}</p>
                </h1>
                        ...
                        <div className="row g-3">
                            <div className="col-sm-12">
                                ...
                                <input
                                    type="text"
                                    name="namaperiode"
                                    defaultValue={props.periode.namaperiode}
                                    placeholder="Masukan Nama Periode"
                                    className="form-control block text-sm py-3 px-4 rounded-lg w-full border outline-none"
                                    autoComplete="namaperiode"
                                    onChange={onHandleChange}
                                />
                                <div className="">
                                    <InputError
                                        message={errors.namaperiode}
                                        className="mt-2"
                                    />
                                </div>
                            </div>
